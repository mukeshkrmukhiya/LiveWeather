...
export default function Weather() {
    ...
    useEffect(()=>{
        const fetchApi = async ()=>{
            ...
            const url = `https://api.openweathermap.org/data/2.5/weather?q=${Search}&units=metric&appid=8b43f8ee3c35a931e3c96556a1341fa6  `
    ...
    <div className=' inputDiv '>
        <input type="search" placeholder= "Enter your city Name" className='Sinput'  onChange={(event)=>setSearch(event.target.value)} />
  
    </div>
    {!City? (<h1 className="errMsg">No Such City Found</h1>):
      ( <div>
        <div className="cardm">
  <div className="card">
    <svg
    ...
    <div className="main"> {City.temp} °C</div>
    <div className="mainsub">{Search}, India</div>
...
<div className=" warning"><h4>For More detail hover It</h4></div>
